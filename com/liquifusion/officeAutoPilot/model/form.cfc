<cfcomponent extends="base">
	...
	<cffunction name="init">
		...
		<cfscript>
			...
			return super.init(url="http://moon-ray.com/api/fdata.php", appId=arguments.appId, key=arguments.key, properties=arguments.properties, $persisted=arguments.$persisted);
		</cfscript>
	</cffunction>
