<cfcomponent extends="base">
	...
	<cffunction name="init">
		...
		<cfscript>
			...
			return super.init(url="https://moon-ray.com/api/pdata.php", appId=arguments.appId, key=arguments.key, properties=arguments.properties, $persisted=arguments.$persisted);
		</cfscript>
	</cffunction>
